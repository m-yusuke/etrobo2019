...
port = "/dev/tty.Bluetooth-Incoming-Port" # 環境に合わせて変更して下さい
baud = 115200
...
def detectColor(points):
    ...
    url = "http://10.0.0.212/?action=stream" # "http://192.168.10.122:8080/?action=stream"
...
################################
def callAI():
    number = ai_main(picture,picture)
    return number
